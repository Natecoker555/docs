---
title: "REST API Endpoints for Action Items and Tasks"
sidebarTitle: "Tasks"
description: "List, update, and manage action items extracted from meetings and assigned to team members via the Progress Pilot tasks API."
---
